package stream.benchmark.nexmark.spout;

import java.util.Map;
import java.util.Random;

import stream.benchmark.nexmark.relation.OpenAuctions;
import stream.benchmark.nexmark.relation.PersonGen;
import stream.benchmark.nexmark.relation.Persons;
import stream.benchmark.nexmark.relation.SimpleCalendar;
