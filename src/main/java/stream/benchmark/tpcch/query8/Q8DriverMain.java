package stream.benchmark.tpcch.query8;
...
public class Q8DriverMain {

	public static void main(String[] args) {
		TopologyBuilder builder = new TopologyBuilder();
		builder.setSpout("spout", new TpcchSpout());
		BoltDeclarer bolt = builder.setBolt("bolt", new Q8HeapBolt());
		...
		builder.setBolt("sink", new Q8Sink()).globalGrouping("bolt");
